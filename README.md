...
6. Operational & Customer Experience
...
The SQL analysis was developed using **SQLite** and includes:

- Data Quality Checks
- Business KPI Analysis
- GMV & Revenue Analysis
...
All SQL queries are available in the:
...
The project also includes detailed business case studies translating the SQL analysis into business insights and recommendations.
...
Detailed analysis is available in the:
...
│   ├── 02_Seller_Performance.png
│   ├── 03_Product_Category_Performance.png
│   ├── 04_Geographical_Performance.png
│   ├── 05_Customer_Performance.png
│   └── 06_Operational_Customer_Experience.png
│
└── Dataset
